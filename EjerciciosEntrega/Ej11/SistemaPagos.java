...
class EmpleadoPorHora extends Empleado {
    ...
    @Override
    public String toString() {
        return super.toString() + " - Pago por hora: $" + obtenerPago();
    }
}
...
class EmpleadoPorComision extends Empleado {
    ...
    @Override
    public String toString() {
        return super.toString() + " - Comisión: $" + obtenerPago();
    }
}
...
class EmpleadoBaseMasComision extends EmpleadoPorComision {
    ...
    public EmpleadoBaseMasComision(String nombre, String documento, double porcentajeComision, double ventasBrutas, double salarioBase) {
    ...
    @Override
    public String toString() {
        return super.toString() + " - Salario Base: $" + salarioBase + " - Pago Total: $" + obtenerPago();
    }
}

// Clase Factura
class Factura implements PorPagar {
    private String proveedor, numeroFactura, fechaCompra;
    ...
    @Override
    public double obtenerPago() {
        return items.stream().mapToDouble(i -> i.precioUnitario * i.cantidad).sum();
    }
    
    @Override
    public String toString() {
        return "Factura de " + proveedor + " - Total: $" + obtenerPago();
    }
...
public class SistemaPagos {
    public static void main(String[] args) {
        List<PorPagar> listaPagos = Arrays.asList(
            new EmpleadoAsalariado("Juan Perez", "12345678", 2500),
            new EmpleadoPorHora("Maria Gomez", "87654321", 20, 160),
            new EmpleadoPorComision("Carlos Ramirez", "13579246", 5, 10000),
            new EmpleadoBaseMasComision("Laura Diaz", "24681357", 5, 12000, 2000)
        );
        ...
        listaPagos.forEach(pago -> System.out.println(pago));
